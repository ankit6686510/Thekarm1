...
const HeroSection = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-100 to-white py-20 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
      <div className="max-w-5xl mx-auto text-center">
        <span className="inline-block px-4 py-2 rounded-full bg-purple-200 text-purple-800 font-semibold text-sm mb-8 animate-fade-in">
          Your Go-To Job Marketplace
        </span>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mb-8 leading-tight">
        ...
        <p className="text-xl text-gray-600 mb-12 animate-fade-in animation-delay-900">
          Find flexible jobs that fit your schedule and skills.
        </p>
        <div className="relative max-w-2xl mx-auto animate-fade-in animation-delay-1200">
          <input
            type="text"
            placeholder="Find Your First Job"
            onChange={(e) => setQuery(e.target.value)}
            className="w-full py-4 px-6 rounded-full shadow-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-lg transition-all duration-300 ease-in-out"
          />
          <Button
            onClick={searchJobHandler}
            className="absolute right-2 top-2 rounded-full bg-yellow-500 hover:bg-yellow-600 transition-all duration-300 ease-in-out py-2 px-6 flex items-center"
          >
